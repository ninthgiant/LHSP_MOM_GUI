...
#default starting place for my computer - do an ASK to set default?
myDir = "/Users/bobmauck/Dropbox/BIG Science/MOMs/2022_Stuff"

my_font1 = ('courier', 10)

## display the label
l1 = tk.Label(root,text='Read File & create DataFrame', width=30,font=my_font1)  
l1.grid(row=1,column=1)

## display the button
b1 = tk.Button(root, text='Browse Files', width=20,command = lambda:upload_file())
b1.grid(row=2,column=1) 

### Make a space to show data under this?
t1=tk.Text(root,width=40,height=50)
t1.grid(row=5,column=1,padx=5, pady=70)
